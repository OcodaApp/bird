...
import '../../user/controllers/map_search_controller.dart';
import 'package:geocoding/geocoding.dart' as geocoding;

class PackageAddLocationController extends GetxController {
                      ...
                      onTap: () async{
                        ...
                        if (result != null && result.result != null) {
                          ...
                          List<geocoding.Placemark> p = await geocoding.placemarkFromCoordinates(
                            lat.value = detailsResult.geometry!.viewport!.southwest!.lat!,
                            detailsResult.geometry!.viewport!.southwest!.lng!,
                            // localeIdentifier: _langController.appLocale == 'ar' ? 'ar' : 'en',
                          );
                          geocoding.Placemark place = p[0];
                          print(place.subAdministrativeArea);
                          city.text = place.subAdministrativeArea.toString();
                          street.text = place.street.toString();
                ...
                child: MaterialButton(
                  ...
                  onPressed: (){
                    if (!_formKey.currentState!.validate()) {
                      ...
                      addAddressController.addAddressPackage(
