...
class ForgetVerifyView extends StatelessWidget {
  String email,code,userId;
  ForgetVerifyView({Key? key,required this.code,required this.email,required this.userId}) : super(key: key);
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                Text(' $email,',style: TextStyle(fontSize: sizeW16,fontWeight: FontWeight.w300,color: greyOpacityColor),textAlign: TextAlign.center,),
              ],
            ),
            ...
            MaterialButton(
              ...
              onPressed: (){
                if(textEditingController.text == code){
                  ...
                  PageRouteTransition.pushReplacement(context,  ForgetChangePasswordView(email:email,userId: userId,));
                }else{
