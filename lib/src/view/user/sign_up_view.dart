...
class SignUpView extends StatelessWidget {
  SignUpView({Key? key,required this.type}) : super(key: key);
        ...
        child: ListView(
          children: [
            ...
            FadeInUp(child:Image.asset('assets/logo.png',width: Get.width / 2,height: Get.height/4.5,),),
             ...
             Text('Sign Up'.tr,style: TextStyle(fontSize: sizeW25,fontWeight: FontWeight.w600,color: blackolor),textAlign: TextAlign.center,),
             SizedBox(height: sizeH35,),
            FadeInUp(
              child: Form(
                key: _formKey,
              ...
              child: MaterialButton(
                ...
                onPressed: (){
                  if (!_formKey.currentState!.validate()) {
                    ...
                    controller.checkEmail(context,type);
                  }
                },
                child:  Text(
