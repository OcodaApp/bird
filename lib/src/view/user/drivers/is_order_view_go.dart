...
import 'controllers/go_order_controller.dart';

class IsOrderViewGo extends StatelessWidget {
  IsOrderViewGo({Key? key,this.order}) : super(key: key);
  var order;
  final GoOrderController controller = Get.put(GoOrderController());
  @override
