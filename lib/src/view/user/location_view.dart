...
class MapSearchView extends StatefulWidget {
  double lat,long;
  MapSearchView({Key? key,required this.lat,required this.long}) : super(key: key);
  @override
  State<MapSearchView> createState() => MapSearchViewState(lat2:lat,long2: long);
}
class MapSearchViewState extends State<MapSearchView> {
  double lat2,long2;
  MapSearchViewState({required this.lat2,required this.long2});
        ...
        children: [
          MapPicker(
            ...
            child: GoogleMap(
              ...
              onCameraMove: (cameraPosition2) async{
                setState(() {
