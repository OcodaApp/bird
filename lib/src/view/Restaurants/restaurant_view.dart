...
import 'products_search_page.dart';

class RestaurantView extends StatelessWidget {
  RestaurantView({Key? key,this.storeData}) : super(key: key);
    ...
    return RefreshIndicator(
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          preferredSize: Size.fromHeight(Get.height / 2.9),
          child: FadeInDown(
            child: SizedBox(
              child: Stack(
                children: [
                  Container(
                    ...
                    decoration:  BoxDecoration(
                      image: DecorationImage(
                            image: NetworkImage(storeData.cover),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(image: NetworkImage(storeData.logo,),fit: BoxFit.fill)
                                ),
                              ),
                                  ...
                                  children: [
                                    ...
                                    Wrap(
                                      children: [
                                        ...
                                        SizedBox(width: sizeW5,),
                                        Text(storeData?.rateAvg?.toString()??"0",style: TextStyle(fontSize: sizeW12,fontWeight: FontWeight.w500,color: primaryColor)),
                                        SizedBox(width: sizeW5,),
                                        SizedBox(
                                          height: sizeH8,
                                          width: sizeW80,
                                          child: Row(
                                            children: [
                                              Text(storeData.rateCount.toString(),style: TextStyle(fontSize: sizeW10,fontWeight: FontWeight.w300,color: primaryColor),overflow: TextOverflow.ellipsis),
                                              Text('Reviews'.tr,
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: sizeW5,),
                                      Text(storeData?.delevryPrice??"0",style: TextStyle(fontSize: sizeW12,fontWeight: FontWeight.w500,color: primaryColor)),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: sizeW5,),
                                      Text(storeData?.km?.toStringAsFixed(2)??"0",style: TextStyle(fontSize: sizeW12,fontWeight: FontWeight.w500,color: primaryColor)),
                                    ],
                                  ),
                                ],
                              ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: sizeW5,),
                                      Text('${storeData.fromTime}- ${storeData.toTime}',style: TextStyle(fontSize: sizeW12,fontWeight: FontWeight.w500,color: primaryColor)),
                                    ],
                                  ),
                                ],
                              ),
